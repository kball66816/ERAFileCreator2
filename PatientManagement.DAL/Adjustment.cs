...
namespace PatientManagement.DAL
{
    ...
    public class Adjustment : INotifyPropertyChanged
    {
        public readonly Dictionary<string, string> AdjustmentReasonCodes = new Dictionary<string, string>
        {
            ...
            {"Copay", "3"},
            {
                "This Procedure code is inconsistent with the modifier used or a required modifier is missing. Usage:Refer to the 835 Healthcare Policy Identification Segment(loop 2110 Service Payment Information REF), if present.",
                "4"
            },
            {
                "The procedure code/bill type is inconsistent with the place of service. Usage: Refer to the 835 Healthcare Policy Identification Segment (loop 2110 Service Payment Information REF), if present.",
                "5"
            },
            {
        ...
        public Adjustment()
        {
            this.adjustmentType = "CO";
            this.adjustmentReasonCode = "45";
        ...
        {
            get => this.adjustmentType;
            set
            {
                if (value != this.AdjustmentType)
                {
        ...
        {
            get => this.adjustmentReasonCode;
            set
            {
                if (value != this.adjustmentReasonCode)
                {
                    this.adjustmentReasonCode = value;
                    this.RaisePropertyChanged("AdjustmentReasonCode");
                }
            }
        }
        ...
        {
            get => this.adjustmentAmount;
            set
            {
                if (value != this.adjustmentAmount)
                {
